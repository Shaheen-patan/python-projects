...
app = Flask(__name__)
model = joblib.load(r"C:\Users\ADMIN\Downloads\Python Placement Classes\Student Mark Predictor Project Deployment\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
